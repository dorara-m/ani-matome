...
- [!] cmsでhtmlを更新するのがやりづらい問題（一度手元で作って貼り付けないといけない 

### アニメ単体の改修

- [!!!] 星空のアニメーションがビルドするたびに差分が出てしまう問題
- [!!] 画像流れる＞速度をGUIでリアルタイムに変えられたらわかりやすいかも！
- [!!] lottie.jsデモ
...
- ウマ娘でつかう予定のチャットしてる風アニメ（参考, peepアプリ
...
デザインは、instaみたいにプレビューとハッシュタグとかあるといいかも。
